...
import { CREATE_BLOCK, CREATE_COLLECTION, CREATE_DISCOUNT, CREATE_LOCATION, CREATE_PLATFORM, CREATE_SCREENSHOT, CREATE_SCREENSHOT_WITH_FILE, CREATE_SERVICE, CREATE_SERVICE_APPLICATION, DELETE_BLOCK, DELETE_COLLECTION, DELETE_DISCOUNT, DELETE_LOCATION, DELETE_PLATFORM, DELETE_SCREENSHOT, DELETE_SERVICE, DELETE_SERVICE_APPLICATION, GET_ALL_SERVICES, GET_ALL_SERVICES_DISCOUNTS, GET_ALL_SERVICES_LOCATIONS, GET_ALL_SERVICES_PLATFORMS, GET_ALL_SERVICES_SIMPLE_LIST, GET_BLOCK, GET_BLOCKS, GET_COLLECTION, GET_COLLECTIONS, GET_MAIN_PAGE, GET_SEARCH, GET_SERVICE, GET_SERVICES_BY_ID, GET_SERVICE_APPLICATIONS, SERVICES_LOADING, SERVICE_DATA_UPDATE, SERVICE_UPDATE_DISCOUNT, SERVICE_UPDATE_LINK, TDiscount, TServiceApplication, TServiceLocation, TServicePlatform, TServiceSearch, TServicesBlock, TServicesCollection, TServicesData, UPDATE_BLOCK, UPDATE_COLLECTION, UPLOAD_SERVICE_LOGO, UPLOAD_SERVICE_LOGO_WITH_FILE, servicesDispatchTypes } from "./types";
...
export const getServicesById = (ids: number[]) => (dispatch: Dispatch<servicesDispatchTypes>) => {
    axios.post(SERVER_URL + '/getServicesById', JSON.stringify({ ids })).then(res => {
        console.log(res.data)

        dispatch({
            type: GET_SERVICES_BY_ID,
            payload: res.data
        })
    }).catch(error => {
        console.log(error)
